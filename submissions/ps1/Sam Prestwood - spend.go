...
var amount = flag.Float64("amount", 0.0, "The amount, in satoshi, to spend.")
...
func main() {
	...
	tx.AddTxOut(txout)
	txout2 := createTxOut(oldTxOut.Value - int64(reqArgs.amount), reqArgs.myPubKey)
	tx.AddTxOut(txout2)
