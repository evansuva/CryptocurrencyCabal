...
** spend.go
** 
** Modified for PS 1 by Alec Grieser (ahg3de).
** 
** cs4501 Fall 2015
** Problem Set 1
*/
...
var amount = flag.Int("amount", -1, "The number of satoshis to send in the transaction.")
...
func main() {
    ...
    // Verify that the amount is fine
    if oldTxOut.Value < reqArgs.amount + TX_FEE {
        fmt.Println("You cannont send more than you have!")
        os.Exit(1)
    }
